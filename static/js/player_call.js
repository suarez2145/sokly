...
let app = new Vue({
    ...
    methods: {
        ...
        submitFile() {
            ...
            formData.append('number', this.result.number)
...
// need to add id dynamically?? cant seem to ad ID and have it find the ID of the player it works if number is hard coded like below 
            ...
            // added after adding add new player to roster page because starters page was not updating after deleting player 
